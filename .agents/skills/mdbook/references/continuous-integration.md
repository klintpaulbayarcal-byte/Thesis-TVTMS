...
* `--vers "^0.5.4"` --- This will install the most recent version of the `0.5` version series.
  However, semver-incompatible versions after like `0.6.0` won't be installed, as they may break your build.
...
[`output.html.input-404`]: https://rust-lang.github.io/mdBook/format/configuration/renderers.html#html-renderer-options
