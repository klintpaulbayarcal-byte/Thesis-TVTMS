...
When you are interested in exploring more features and options that mdBook provides, check out the [Configuration chapter](https://rust-lang.github.io/mdBook/format/configuration/index.html) for more details.
...
For more details on other formatting options for the summary file, check out the [Summary chapter](https://rust-lang.github.io/mdBook/format/summary.html).
...
For more information about publishing and deploying, check out the [Continuous Integration chapter](https://rust-lang.github.io/mdBook/continuous-integration.html) for more.
