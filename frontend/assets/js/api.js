...
// Production normally uses the same-origin REMOVED_HOST rewrite. If that rewrite is
...
const LOGIN_FALLBACK_API_BASE_URL = window.location.hostname === 'thesis-tvtms.REMOVED_HOST.app'
    ? 'https://thesis-tvtms-api.REMOVED_HOST.app/api'
    : '';
